            ...
            <Col md={8} xs={12}>
              <motion.div className="intro-section">
                ...
                <motion.h1 variants={titleAnim} className="mb-4">
                  Hi, I'm <span className="chonburi-font green-text">Shivam </span>
                  Sahu
                </motion.h1>
                <motion.h2 variants={titleAnim} className="mb-4">Software Engineer at 
                  <strong><div className="chonburi-font green-text"> DXC Technology </div>{" "}
                  </strong>
                </motion.h2>
              </motion.div>
            </Col>
